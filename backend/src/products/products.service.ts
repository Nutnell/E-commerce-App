  ...
  private async seedProducts() {
    ...
    const mockProducts: Partial<Product>[] = [
      ...
      },
      {
        ...
        rating: 4.3,
        ratingCount: 11,
        imageUrl: '/assets/women_pleated_mini_skirt.png',
        isNew: false,
        isSale: false,
        category: 'clothes',
        subcategory: 'skirts',
      ...
      // ---- Women's Clothes: Jeans ----
      {
        ...
        rating: 4.2,
        ratingCount: 9,
        imageUrl: '/assets/women_skinny_jeans.png',
        isNew: false,
        isSale: true,
        category: 'clothes',
        subcategory: 'jeans',
      ...
      { name: 'Resort Beachwear Cover-up', brand: 'Zara', price: 29.0, originalPrice: 39.0, discountPercent: 25, rating: 4.7, ratingCount: 18, imageUrl: '/assets/cat_beachwear.png', isNew: false, isSale: true, category: 'beachwear', subcategory: 'beachwear', gender: 'women', colors: 'white,tan', sizes: 'S,M,L' },
      ...
      { name: 'Classic Jeanswear Jacket', brand: 'Levi\'s', price: 65.0, rating: 4.9, ratingCount: 34, imageUrl: '/assets/cat_jeanswear.png', isNew: true, isSale: false, category: 'jackets', subcategory: 'jeans', gender: 'women', colors: 'blue,black', sizes: 'S,M,L' },
      ...
      { name: 'Executive Office Blazer', brand: 'Zara', price: 79.0, rating: 4.8, ratingCount: 25, imageUrl: '/assets/cat_officestyle.png', isNew: true, isSale: false, category: 'jackets', subcategory: 'blouses', gender: 'women', colors: 'black,tan,grey', sizes: 'S,M,L' },
      ...
      { name: 'Glamour Partywear Dress', brand: 'Dorothy Perkins', price: 59.0, rating: 4.9, ratingCount: 30, imageUrl: '/assets/cat_partywear.png', isNew: true, isSale: false, category: 'dresses', subcategory: 'partywear', gender: 'women', colors: 'gold,red,black', sizes: 'S,M,L' },
